...
%% {@link run/5} and handles possible failures. Also measures the execution
%% time. If successful, returns a summary, as generated by
%% {@link get_summary/10}.
-spec check_run( Submit :: #submit{}, Dir ) -> #reply_ok{} | #reply_error{}.
